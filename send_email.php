...
if ($_POST['action'] == 'Send Message') {
	...
	if ($_POST['cannedMsg'] == 'WEEKLY_PICKS_REMINDER') {
		...
		$sql .= "(select count(p.pickID) from nflp_picks p inner join nflp_schedule s on p.gameID = s.gameID where userID = u.userID and s.weekNum = " . $week . " and s.year = " . $year . ") as userPicks ";
